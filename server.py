...
def init_db():
    ...
    if count == 0:
        homes = [
            ("5 Pond Cypress Way", "HOME-01"),
            ("9 Running Oak Circle", "HOME-02"),
            ("12 Viridian Park Drive", "HOME-03"),
            ("19 Muhly Circle", "HOME-04"),
            ("20 Tall Timber Court", "HOME-05"),
            ("21 Chanel Court", "HOME-06"),
            ("22 Flatwood Street", "HOME-07"),
            ("25 Rain Lily Lane", "HOME-08"),
            ("25 Lake District Lane", "HOME-09"),
            ("29 Royal Fern Way", "HOME-10"),
            ("31 Bluejack Street", "HOME-11"),
            ("35 Suzanne Drive", "HOME-12"),
            ("37 Red Cedar Way", "HOME-13"),
            ("37 Compass Point II, Unit 106", "HOME-14"),
            ("43 Sand Hill Circle", "HOME-15"),
            ("44 Thicket Circle", "HOME-16"),
            ("46 Pine Needle Way", "HOME-17"),
            ("49 Bluejack Street", "HOME-18"),
            ("51 Mistflower Lane", "HOME-19"),
            ("53 Muhly Circle", "HOME-20"),
            ("65 Pond Cypress Circle", "HOME-21"),
            ("70 Scrub Oak Circle", "HOME-22"),
            ("70 Sunset Ridge Lane", "HOME-23"),
            ("72 Needlerush Drive", "HOME-24"),
            ("73 Holly Street", "HOME-25"),
            ("73 Pond Cypress Circle", "HOME-26"),
            ("75 East Summersweet Lane", "HOME-27"),
            ("80 Scrub Oak Circle", "HOME-28"),
            ("86 Sunset Ridge Lane", "HOME-29"),
            ("90 Flatwood Street", "HOME-30"),
            ("91 Bluejack Street", "HOME-31"),
            ("93 Needlerush Drive", "HOME-32"),
            ("97 East Summersweet Lane", "HOME-33"),
            ("99 Pond Cypress Way", "HOME-34"),
            ("100 Tumblehome Way", "HOME-35"),
            ("109 Dandelion Drive", "HOME-36"),
            ("124 Sunset Ridge Lane", "HOME-37"),
            ("134 Royal Fern Way", "HOME-38"),
            ("138 East Royal Fern Way", "HOME-39"),
            ("142 Mystic Cobalt Street", "HOME-40"),
            ("157 Sunflower Street", "HOME-41"),
            ("176 Red Cedar Way", "HOME-42"),
            ("179 Pine Needle Way", "HOME-43"),
            ("184 East Royal Fern Way", "HOME-44"),
            ("194 Spartina Circle", "HOME-45"),
            ("202 East Royal Fern Way", "HOME-46"),
            ("209 Western Lake Drive", "HOME-47"),
            ("254 Spartina Circle", "HOME-48"),
            ("255 Garfield Street", "HOME-49"),
            ("260 Needlerush Drive", "HOME-50"),
            ("262 Garfield Street", "HOME-51"),
            ("263 Magnolia Street", "HOME-52"),
            ("271 Red Cedar Way", "HOME-53"),
            ("295 Salt Box Lane", "HOME-54"),
            ("349 Needlerush Drive", "HOME-55"),
            ("369 Spartina Circle", "HOME-56"),
            ("379 East Royal Fern Way", "HOME-57"),
            ("394 Western Lake Drive", "HOME-58"),
            ("406 Red Cedar Way", "HOME-59"),
            ("410 Pine Needle Way", "HOME-60"),
            ("422 Pine Needle Way", "HOME-61"),
            ("428 Red Cedar Way", "HOME-62"),
            ("433 Pine Needle Way", "HOME-63"),
            ("442 East Royal Fern Way", "HOME-64"),
            ("446 Western Lake Drive", "HOME-65"),
            ("672 Western Lake Drive", "HOME-66"),
            ("728 Western Lake Drive", "HOME-67"),
            ("1217 Western Lake Drive", "HOME-68"),
            ("1352 Western Lake Drive", "HOME-69"),
            ("1735 East Co Hwy 30A #203", "HOME-70"),
            ("2060 E Co Hwy 30A", "HOME-71"),
            ("2743 E Co Hwy 30A, Unit 303", "HOME-72"),
        ...
        # Create 10 bags per home (A through J)
        all_homes = db.execute("SELECT * FROM homes").fetchall()
        for home in all_homes:
            for i in range(1, 11):
                bag_id = f"{home['code']}-{chr(64+i)}"
